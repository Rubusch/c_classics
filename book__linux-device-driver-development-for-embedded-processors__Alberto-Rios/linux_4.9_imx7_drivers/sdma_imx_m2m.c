			  ...
			  size_t count, loff_t * offset)
{
	...
	dma_m2m_desc = dma_dev->device_prep_dma_memcpy(dma_priv->dma_m2m_chan, dma_dst,
...
static int __init my_probe(struct platform_device *pdev)
{
	...
	dma_device->dma_m2m_chan = dma_request_channel(dma_m2m_mask, dma_m2m_filter, 
							&m2m_dma_data);
